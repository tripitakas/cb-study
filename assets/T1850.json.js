...
,
  ...
  [
    176,
    "是故三界一切。皆以(八識)心為自性。離(八識)心則無六塵境界。何以故。一切諸法。以(第八)心為主。從(第七)妄念起。凡(八識)所分別。皆分別(八識)自心(所變相分)心不見心。無相可得。是故當知。一切世間境界之相。皆依眾生無明妄念而得建立。如鏡中像。無體可得。唯從虛妄分別心轉。心生則種種法生。心滅則種種法滅故",
...
,
  ...
  [
    186,
    "此(不覺)所生染心。有六種別。一執相應染。聲聞。緣覺。及信相應地諸菩薩。能遠離",
  ...
  [
    205,
    "粗中之細。及細中之粗。菩薩智境。細中之細。是佛智境(藏中失此八字准梁本補)",
    "粗中之細。即不斷相應染。分別智相應染。細中之粗。即現色不相應染。見心不相應染。菩薩。謂淨心地已上。細中之細。即根本業不相應染。唯有佛智。乃能照其源也。"
  ],
  [
    206,
    "此(粗細)二種相。皆由無明熏習力起。然依因。依緣。因是不覺。緣是妄境。因滅則緣滅。緣滅故相應心滅。因滅故不相應心滅",
  ...
  [
    210,
    "如水因風。而有動相。以風滅故。動相即滅。非水體滅。若水滅者。動相應斷。以無所依(之水則)無能依(之動)故。以水體不滅動相相續",
    "水。喻心體。風。喻無明。動。喻心相也。"
  ],
  [
    211,
  ...
  [
    212,
    "以心體不滅。心動相續",
    "梁云。以體不滅。心得相續。唯癡滅故。心相隨滅。非心智滅。(文)是知但滅染相。名為不動。而四智心品。即是真如相大。恒起真如用大。仍可名為心動相續矣。然由了達無動而動所以動無動相。不同世諦境界作用。非一切眾生心意識所能思量也。初明染淨生滅竟。"
  ],
  [
    219,
  ...
  [
    348,
    "問。虛空無邊故。世界無邊。世界無邊故。眾生無邊。眾生無邊故。心行差別亦復無邊。如是境界。無有齊限。難知難解。若無明斷。永無心相。云何能了一切種。成一切種智。答。一切妄境。從本已來。理實唯一心為性。一切眾生。執著妄境。不能得知一切諸法第一義性。諸佛如來。無有執著。則能現見諸法實性。而有大智。顯照一切染淨差別。以無量無邊善巧方便。隨其所應。利樂眾生。是故(唯其)妄念心滅(乃能)了一切種。成一切種智",
...
,
  ...
  [
    437,
    "云何利益分。如是大乘祕密句義。今已略說。若有眾生。欲於如來甚深境界廣大法中。生淨信覺解心。入大乘道無有障礙(者)於此略論。當勤聽受。思惟修習。當知是人。決定速成一切種智",
